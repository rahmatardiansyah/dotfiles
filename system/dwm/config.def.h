...
static char selbordercolor[]             = "#e06c75";
...
static const Rule rules[] = {
	...
	RULE(.class = "PrismLauncher", .isfloating = 1)
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_s,       spawn,                     SHCMD("pavucontrol --tab=1") },
    { MODKEY,                       XK_q,       spawn,                     SHCMD("dwm-kill.sh") },
    { MODKEY|ShiftMask,             XK_Escape,  spawn,                     SHCMD("dwm-powermenu.sh") },
    { MODKEY,                       XK_n,       spawn,                     SHCMD("dwm-notification-toggle.sh") },
    { MODKEY|ShiftMask,             XK_p,       spawn,                     SHCMD("dwm-presentation-toggle.sh") },
    /* Function */
    { 0, XF86XK_AudioRaiseVolume,	            spawn,                     SHCMD("pamixer --increase 5; pkill -RTMIN+7 dwmblocks") },
